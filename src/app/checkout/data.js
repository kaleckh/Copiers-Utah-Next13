        ...
        {bottomToggle ? (
          <>
            <div className={styles.centerStuff}>
              ...
              >
                Your order has been succesful! You will receive a confirmation
          ...
          <div className={styles.container}>
              ...
              <div>
                {cart.map((item, index) => {
                  return (
                    <div
                      key={index}
                      className={`${styles.dataResult} ${hidden ? styles.showing : styles.hidden}`}
                    >
                      <div style={{ display: "flex" }}>
            ...
            <div className={styles.middleCenter}>
              ...
              <div className={styles.bottomPieceContainer}>
                ...
                {maybe ? (
                  ...
                  <>
                    <div
                      className={styles.checkoutSmallTitle}
                      onClick={() => {
                        setMaybe(!maybe);
                      }}
                    >
                ...
                <div className={styles.center}>
                  <div className={styles.checkoutParagraph}>
                  ...
                  >
                    <div
                      style={{ margin: "5px", width: "126%" }}
                      className={styles.line}
                    ></div>
                    <div className={styles.billing}>Billing Address</div>
                    <div
                      style={{ width: "113%", paddingTop: "10px" }}
                    ...
                    <input
                      ...
                      style={{ width: "113%", marginTop: "15px" }}
                      className={styles.inputB}
                      type="text"
                      placeholder={"Enter your address here"}
                    />
            ...
            <div className={styles.smaller}>
              ...
              <input
                ...
                className={styles.inputB}
                type="text"
                placeholder={"Put card number here"}
              />
              <div className={styles.row}>
                <input
                  onChange={(event) => {
