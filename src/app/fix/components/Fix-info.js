        ...
        <div className={`${styles.fifty} ${styles.pic} ${styles.hidden}`}>
          <div style={{ width: "90%" }}>
            <div className={styles.paragraph}>
              ...
              providing top-notch maintenance services that go the extra mile to
              keep your office running smoothly and efficiently. Our dedicated
              team of friendly and skilled technicians is here to ensure that
              your copiers are always in optimal condition, delivering
              consistent performance and minimizing any disruptions to your
              workflow.
              <div />
              <div className={styles.paragraph}>
                ...
                support is available to you, regardless of the copier brand you
                use. Our experienced technicians possess comprehensive knowledge
                and expertise to handle maintenance and repairs for a wide range
                of copier models, including renowned brands like Konica Minolta,
                Lexmark, Epson, and more. Rest assured, we have the expertise
                and resources to meet your copier requirements with utmost
                precision and care.
              </div>
            </div>
          </div>
