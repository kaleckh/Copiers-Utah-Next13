            ...
            <div className={styles.boxContainerTwo}>
              <div className={styles.box}>
                ...
                <div className={styles.centerStuff}>
                  ...
                  <div className={styles.serviceParagraph}>
                    Experiencing copier issues? We've got you covered! Our
                    expert technitians are your go-to team for fast and reliable
                    copier repairs. No matter the brand or model, we specialize
                    in fixing copiers efficiently, ensuring minimal downtime for
                    your business.
                  </div>
                </div>
                <Link href={"/fix"}>
              ...
              <div className={`${styles.box} `}>
                ...
                <div className={styles.centerStuff}>
                  ...
                  <div className={styles.serviceParagraph}>
                    Level up your business tech game effortlessly by diving into
                    our expert IT services. We're all about quick solutions and
                    crystal-clear communication, making the whole process smooth
                    as silk for you. Let's upgrade your tech with a touch of
                    ease and expertise.
                  </div>
                </div>
                <Link href={"/it"}>
              ...
              <div className={styles.box}>
                ...
                <div className={styles.centerStuff}>
                  ...
                  <div className={styles.serviceParagraph}>
                    ...
                    – perfect for conventions and those temporary document
                    crunch times. Our top-notch copiers handle the heavy
                    printing load with ease, ensuring your materials are on
                    point. Count on us for laid-back, efficient, and pro-level
        ...
        <div className={`${styles.sectionMedium} ${styles.hideBox} `}>
          <div className={styles.image1}>
            ...
            <div className={styles.paragraphNormal}>
              Copiers Utah offers new copiers sales, leases and rentals. Plus,
              we run Utah's leading copier rebuild center for top-notch
              refurbished copiers. Our skilled technicians can repair nearly any
              copier brand. For cutting-edge IT services, check out our sister
              company, Alien IT Services. Your one stop solution for quality and
              expertise.{" "}
            </div>
          </div>
          <div className={styles.image2}>
            ...
            <div className={styles.paragraphNormal}>
              ...
              services. Our copier rebuild service agreements encompass all
              toner, parts and on-site repairs, and a first year replacement
              gurantee. When you choose us, rest assured your copier will
              operate seamlessly in your office, providing you with complete
              peace of mind.
            </div>
          </div>
        </div>
        <div style={{ paddingTop: "80px" }} className={styles.section}>
          ...
          <div className={styles.sectionContainer}>
            ...
            <div className={styles.paragraphMedium}>
              Welcome to Copiers Utah, your ultimate destination for
              comprehensive copier solutions in the heart of Utah. Whether
              you're looking for copiers for sale, leasing options, or
              convenient short-term copier rentals, we've got you covered. Our
              shelves boast a diverse selection of top-notch copiers from
              renowned brands such as Lexmark, Konica Minolta, and Epson,
              ensuring you'll find the perfect fit for your specific business
              requirements.
            </div>
            <div className={styles.paragraphMedium}>
            ...
            <div className={styles.paragraphMedium}>
              ...
              promise of quality and reliability. Our mission is to offer not
              only top-tier copiers but also unparalleled service, with all
              copier rentals and sales. Whether you're seeking a long-term
              copier solution or a quick fix, count on us for our extensive
              expertise and unwavering dedication to meeting your copier needs.
            </div>
          </div>
        </div>
        <div
        ...
        >
          ...
          <div className={styles.sectionContainer}>
            ...
            <div className={styles.paragraphMedium}>
              ...
              support and managed IT services in Utah. From comprehensive
              network security to proactive approaches in ransomware protection
              and secure setup, we offer a range of expert IT services tailored
              to streamline your digital solutions. Our reliable support team is
              dedicated to ensuring efficient data management and secure
              collaboration for Utah businesses. With a strong focus on cloud
              computing and backup and restore solutions, Alien IT Services is
              your go-to partner for all things IT.
            </div>
            <div className={styles.paragraphMedium}>
              At Alien IT Services, we believe in taking a proactive approach to
              IT solutions. Our comprehensive range of services includes
              technical support, printer support, and software and app support
              for businesses in Utah. We specialize in ensuring network
              efficiency and secure data management, offering reliable support
              and fix for broken hardware when you need it most. With a strong
              focus on delivering expert IT services and reliable support, Alien
              IT Services is committed to providing top-notch digital solutions
              for businesses in the Utah area.{" "}
            </div>
            <div className={styles.paragraphMedium}>
              In the fast-paced world of technology, having a reliable IT
              support system is crucial for Utah businesses. Alien IT Services
              offers a wide range of IT solutions, including managed IT services
              and network security, tailored to meet the specific needs of local
              ...
              committed to providing tailored digital solutions for businesses
          ...
          <div className={styles.rowSpaced}>
            <div className={styles.boxReview}>
              ...
              <div className={styles.paragraphReview}>
                These guys do not disappoint! I have done business with them for
                a few years now. They have great customer service and amazing
            ...
            <div className={`${styles.boxReview} ${styles.hideBox}`}>
              ...
              <div className={styles.paragraphReview}>
                ...
                able to get me up and running in a few days with an awesome
                refurbished copier!
              </div>
            </div>
            <div className={styles.boxReview}>
              ...
              <div className={styles.paragraphReview}>
                ...
                and very helpful. I will be recommending them to everyone. I
